...
class grid_map(object):
	...
	def inv_model(self, cell, msg):
		...
		pose = self.world_to_grid(self.pose) #gives x and y of the robot position
		...
		if  msg.ranges[k] > msg.range_min and msg.ranges[k] < msg.range_max: #discard unvalid values
